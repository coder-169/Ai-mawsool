...
const ButtonVariants = cva(
  "px-4 py-2 text-sm disabled:opacity-80 text-center font-medium rounded-md focus:ring ring-primary/10 outline-none flex items-center justify-center gap-2 transition-opacity",
  {
    variants: {
      variant: {
        success:"bg-green-500 border border-transparent dark:border-white disabled:bg-green-200 disabled:hover:bg-green-300 text-white dark:bg-white dark:text-black hover:bg-green-600 dark:hover:bg-gray-200 transition-colors",
        primary:
